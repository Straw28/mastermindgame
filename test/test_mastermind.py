...
class MasterMindTests(unittest.TestCase):
  ...
  @parameterized.expand(
      [
        ...
        ([YELLOW, RED, GREEN, ORANGE, CYAN, PINK], [VIOLET, BLUE, TEAL, MAGENTA, VIOLET, BLUE], [UNKNOWN] * 6),
        ([YELLOW, RED, GREEN, ORANGE, CYAN, PINK], [YELLOW, RED, GREEN, ORANGE, VIOLET, MAGENTA], [EXACT, EXACT, EXACT, EXACT, UNKNOWN, UNKNOWN]),
        ...
        ([YELLOW, RED, MAGENTA, CYAN, PINK, ORANGE], [VIOLET, RED, GREEN, PINK, ORANGE, CYAN], [EXACT, PARTIAL, PARTIAL, PARTIAL, UNKNOWN, UNKNOWN]),
        ...
        ([YELLOW, RED, MAGENTA, CYAN, PINK, ORANGE], [TEAL, YELLOW, YELLOW, YELLOW, YELLOW, YELLOW], [PARTIAL, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN])
      ]
  )
  ...
  def test_play_game_game_over(self):
    game = MasterMindGame()
    game.MAX_TRIES = 1
    game.selected_colors = [RED, PINK, GREEN, VIOLET, PINK, ORANGE]
    with patch('builtins.input', side_effect=["red blue green yellow pink teal"]):
      game.play_game()
